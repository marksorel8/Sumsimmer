...
pred_harv<-exp(stats::predict(pfm_mort_mod,newdata=data.frame(RMRS=seq(1000,150000,by=10000))))
...
plot(seq(1000,150000,by=10000),(pred_harv),type="l",ylab="PFMC NT AEQ morts",xlab="Rivermouth run size",ylim=c(0,20000))



polygon(c(seq(1000,150000,by=10000),rev(seq(1000,150000,by=10000))),
        c(exp(log(pred_harv)+(2*sd_lar_pfmc)),rev(exp(log(pred_harv)-(2*sd_lar_pfmc)))),col="lightgrey",border="lightgrey")


polygon(c(seq(1000,150000,by=10000),rev(seq(1000,150000,by=10000))),
        c(exp(log(pred_harv)+(1*sd_lar_pfmc)),rev(exp(log(pred_harv)-(1*sd_lar_pfmc)))),col="grey",border="grey")
...
points(seq(1000,150000,by=10000),exp(log(pred_harv)+(1*sd_lar_pfmc)),type="l",lty=2)
points(seq(1000,150000,by=10000),exp(log(pred_harv)+(-1*sd_lar_pfmc)),type="l",lty=2)
