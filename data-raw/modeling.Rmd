...
pfm_mort_mod<-lm(log(PFMCNT)~(RMRS)-1,data=pfmc_mort_dat)
...
##total
pfmc_morts_2|> ggplot(aes(x=total_allowed,y=Total_harvest))+geom_point()+geom_smooth(method="lm",formula=("y~x-1"),se=FALSE)+geom_abline(intercept=0,slope=1,lwd=1.5)+facet_wrap(~Sector)
