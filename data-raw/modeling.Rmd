...
pfmc_morts_2|>
  ggplot(aes(x=(in_river_allowed_HR),y=qlogis(in_river_HR)))+geom_point()+geom_smooth(method="lm",formula=("y~(x)"),se=FALSE)+facet_wrap(~Sector)+geom_abline(intercept=0,slope=1,lwd=1.5)
