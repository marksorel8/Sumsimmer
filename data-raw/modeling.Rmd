...
##in river
pfmc_morts_2|> 
  ggplot(aes(x=Allowed_in_river,y=In_river_harvest))+geom_point()+#geom_smooth(method="lm",formula=("y~(x)"),se=FALSE)+
  geom_abline(intercept=0,slope=1,lwd=1.5)+facet_wrap(~Sector)+ylim(0,38000)+ylab("In-rive harvest")+xlab("Allowed in river")
