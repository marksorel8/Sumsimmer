...
if(sim_for_model){
  ...
  if(add_baselines){
    ...
    internal_data$`Simplified MA` <-list(perf=summarize_sim(do.call(pop_sim,simplified_MA),HCR="Simplified MA"),hcr=do.call(seq_HCR,simplified_MA))
