...
esc_dat |> filter(year>=2008)|> ggplot(aes(x=NOS,y=HOS))+geom_point()+facet_wrap(~population_name)+geom_smooth()


phos_dat |> ggplot(aes(x=hatchery_escapement,y=HOS))+geom_point()+facet_wrap(~population_name)+geom_smooth(method = "lm")
                                            phos_dat |> ggplot(aes(x=NOS,y=HOS))+geom_point()+facet_wrap(~population_name)+geom_smooth(method = "lm")                     
