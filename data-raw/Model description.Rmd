...
I explored different assumptions regarding the contribution of hatchery-origin spawners to production and found some data support (based on AIC) for the following model. For the per-capita reproductive contribution of a hatchery-origin spawner relative to a natural origin spawner, I used the 10-year running average of proportionate natural influence (PNI) through the the brood year 4 years prior to the current year:
