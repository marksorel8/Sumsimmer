...
where $p^\text{Mark total}$ is the mark rate of the total run, which is calculated as the hatchery mark rate times the hatchery run size, devided by the total river mouth run size including natural-origin fish. Note that the denominator in the above equation is the proportion of handled fish that do not survive. 
